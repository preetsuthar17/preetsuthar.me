    ...
    <section className="projects" id="projects">
      ...
      <div className="projects-content">
        <div className="projects-cards-lists" style={projectCardsListStyle}>
          <ProjectCard
            image="https://i.imgur.com/fSigzlR.png"
            title="HextaStudio"
            content="We're a full-service digital agency specializing in website development, web design, UI/UX, and front-end development. Our team delivers exceptional digital products and experiences tailored to your business needs."
            numbering="1"
            projectLink="https://hextastudio.in"
          />
          <ProjectCard
            image="https://i.imgur.com/UhITKna.png"
            title="HextaUI"
            content="Elevate your projects with stunning, modern components. Simply copy and paste these responsive, beautiful elements for instant awesomeness."
            numbering="2"
            projectLink="https://ui.hextastudio.in"
          />
          <ProjectCard
