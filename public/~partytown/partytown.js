    ...
    ((_t) => {
      ...
      do {
        Object.getOwnPropertyNames(n).forEach((t) => {
          typeof n[t] === 'function' && e.add(t);
        });
      } while ((n = Object.getPrototypeOf(n)) !== Object.prototype);
      return Array.from(e);
    })()
  );
!((t, r, o, i, a, s, c, d, l, p, u, f) => {
  function h() {
    f ||
      ((f = 1),
  ...
  function y(e) {
    (p = r.createElement(e ? 'script' : 'iframe')),
      ...
      (p.src = `${c}partytown-${e ? 'atomics.js?v=0.10.3-dev1734732935152' : `sandbox-sw.html?${t._pttab}`}`),
                ...
                : (() => {
                    ...
                    if (i) {
                      const { methodOrProperty: n, thisObject: r } = ((
                        ...
                        return {
                          thisObject: n,
                          methodOrProperty: e.length > 0 ? n[e.at(-1)] : void 0,
                        };
                      })(t, o);
                      typeof n === 'function' &&
                        (e = (...t) => n.apply(r, ...t));
